...
type EncodeOptions struct {
	Quality      int
	Compression  heif.Compression
	LosslessMode heif.LosslessMode
	LoggingLevel heif.LoggingLevel
}
...
func WithEncodeCompression(Compression heif.Compression) EncodeOption {
	return func(opts *EncodeOptions) {
...
func WithEncodeLosslessMode(LosslessMode heif.LosslessMode) EncodeOption {
	return func(opts *EncodeOptions) {
...
func WithEncodeLoggingLevel(LoggingLevel heif.LoggingLevel) EncodeOption {
	return func(opts *EncodeOptions) {
...
func Encode(w io.Writer, img image.Image, opt ...EncodeOption) error {
	opts := EncodeOptions{
		Quality:      100,
		Compression:  heif.CompressionHEVC,
		LosslessMode: heif.LosslessModeEnabled,
		LoggingLevel: heif.LoggingLevelBasic,
	}
	for _, o := range opt {
		o(&opts)
	}
	...
	ctx, err := heif.EncodeFromImage(img, opts.Compression, opts.Quality, opts.LosslessMode, opts.LoggingLevel)
	if err != nil {
		return err
	}
